    ...
    <AnimatePresence>
      {isLoading && (
        <motion.div
          ...
          className="fixed inset-0 w-full h-screen bg-[#1464F4] z-[100000] flex items-center justify-center"
        >
          {/* Logo Container */}
          <motion.div 
          ...
          >
            ...
            <div className="text-blue-900/30">
              Rohit<span className="text-blue-900/30">.</span>
            </div>
            ...
            >
              Rohit<span className="text-black">.</span>
            </motion.div>
          </motion.div>
